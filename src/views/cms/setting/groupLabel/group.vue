<template>
   <div class="">
    ...
    <el-table-column label="操作">
      ...
      <el-dialog
          ...
          :before-close="backgroup"
          width="35%"
          >
          <el-form :model="gronpdata" style="margin-left:15%">
            <el-form-item label="栏目组名称：" style="width:80%">
              <el-input v-model="gronpdata.groupName" autocomplete="off"></el-input>
            </el-form-item>
            ...
            <el-button type="info" @click="backgroup">取 消</el-button>
  ...
  <div style="margin-bottom:15px;border-bottom:1px solid #eee"></div>
    <el-button type="success" @click="dialogVisible = true">新建栏目组</el-button>
    <el-dialog
      title="添加栏目组"
      append-to-body
      :visible.sync="dialogVisible"
      :before-close="groupback"
      width="35%"
      >
      <el-form :model="gronpdata" style="margin-left:15%">
        <el-form-item label="栏目组名称：" style="width:80%">
        ...
        <div style="width:80%;display:flex;justify-content:flex-end;">
        <el-button type="info" @click="groupback">取 消</el-button>
...
import { addGroup , getChannelGroup ,delGroup ,modifyGroup} from "@/api/backgroundSystem/Channel";

  @Component({
    components: {}
  })
  export default class group extends BaseView {
 ...
 private handleEdit(row:any) {
    ...
    this.gronpdata.groupName = row.groupName
    this.gronpdata.description = row.description
    
    }
 private modify(){
   let {id,groupName,description} = this.gronpdata
 ...
 private handleDelete(row:any) {
  ...
  //添加栏目组
  private addgroup() {
    let { groupName, description } = this.gronpdata;
    addGroup.request({ groupName, description }).then(res => {
