<template>
  <div>
    <el-card v-if="true" style="min-height:100%;">
      <div slot="header" class="clearfix" @click="initData">
        <span>
          <i class="el-icon-refresh" :class="{rotate:rotateFlag}"></i> 短信配置
        </span>
      </div>
...
export default class MessageConfig extends BaseView {
